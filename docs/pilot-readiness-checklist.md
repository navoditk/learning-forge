...
| Identity and access | Managed identity choice, parent/learner linking, household authorization tests, support-access procedure | Product/engineering + privacy | Decided 2026-09-06 (ADR-0008): simple email/password or magic-link; parent manages the learner profile directly. Implementation and authorization tests still pending. |
